(function () {
    ...
    addCommand(0, "kill", function (src, commandData, chan) {
        var broadcast = this.semuted ? Utils.sendHtmlSemuted : sys.sendHtmlAll,
            tar = this.target;
        ...
        Deaths[0] = "" + commandData + " looked at " + sys.name(src) + "'s face and died of laughter!";
        Deaths[1] = "" + commandData + " has been picked up by a giant ape and eaten!";
        Deaths[2] = "" + commandData + " was jumped by a gang of hoods but whooped their asses! Just kidding, he got murdered!";
        Deaths[3] = "" + commandData + " looked in the mirror...nuff said";
        Deaths[4] = "" + commandData + " got in a fight with a toddler and failed!";
        Deaths[5] = "" + commandData + " walked on the railroad and got hit by a train! What a dumbass!";
        Deaths[6] = "" + commandData + " volunteered for the Hunger Games and was the first one killed!";
        Deaths[7] = "" + commandData + " was forced to go to a One Direction concert. Ouch...";
        Deaths[8] = "" + commandData + " jumped off a skyscraper, was shot midway, survived, landed in a tree, got a branch stuck in their arm, fell off onto a rock, lived, but then died because they tripped on a ladybug on the sidewalk. GG.";
            var Mates = new Array();
            Mates[0] = "Justin Bieber";
            Mates[1] = "Kim Kardashian";
            Mates[2] = "Rosie O'Donnell";
            Mates[3] = "Barack Obama";
            Mates[4] = "Osama bin Laden";
            Mates[5] = "Selena Gomez";
            Mates[6] = "a corpse";
            Mates[7] = "a wild Garbodor";
            Mates[8] = "the Deez Nuts guy";
            Mates[9] = "a tranny from Thailand";
            Mates[10] = "a brick wall";
            Mates[11] = "Michael Jackson";
            Mates[12] = "Emma Watson";
            Mates[13] = "a male model";
            Mates[14] = "George Bush";
            Mates[15] = "Ian";
            Mates[16] = "Santa Claus";
            var r = Math.floor(Mates.length * Math.random());
        Deaths[9] = "" + commandData + " died from a heart attack after having sex with " + Mates[r] + " all night long!";
		Deaths[10] = "" + commandData + " was sacrificed to Lord Chin Chin.";
		Deaths[11] = "" + commandData + " died and nobody attended their funeral.";
		Deaths[12] = "" + sys.name(src) + " tried to inject " + commandData + " with the Ebola virus, but accidentally injected themselves and died in agony.";
        Deaths[13] = "" + sys.name(src) + " got ganked by a gang of Pichus!";
		var i = Math.floor(Deaths.length * Math.random());
        Bot.kill.sendAll(Deaths[i], chan);
    });
    ...
    addCommand(0, "scriptinfo", function (src, commandData, chan) {
        sys.sendHtmlMessage(src, [
            ...
            "<font color=black><timestamp/><b>Viper's Pit™ v1.0 Scripts</b></font>",
            "<font color=blue><timestamp/><b>Created By:</b></font> <b><font color=navy>Blade</font>, <font color=#00aa7f>cares</font>, Ethan</b>",
            "<font color=red><timestamp/> <b>Maintainers:</b></font> " + Config.maintainers.join(", ") + ".",
            ...
            "<font color=black><timestamp/><b> © <a href='http://viperspit.cf/forums/'>Viper's Pit</a> 2016 [MIT license] </b></font>",
    ...
    addCheatCode(["eval", "seval"], function (src, commandData, chan) {
        ...
        try {
            ...
            if(this.command != "seval") Utils.watch.notify("Result: " + Utils.escapeHtml(res));
            sys.sendHtmlMessage(src, "<timestamp/><b>Result [<font color=green>OK</font>]:</b> " + Utils.escapeHtml(res), chan);
        } catch (error) {
      	    if(this.command != "seval") Utils.watch.notify("Error: " + error);
            ...
            if (error.backtrace) {
                ...
                if(this.command != "seval") Utils.watch.notify("Backtrace: " + Utils.escapeHtml(error.backtrace.join("<br>")));
            }
        }
    });
    ...
    addMaintainerCommand("destroychan", function (src, commandData, chan) {
    ...
    addMaintainerCommand("changeauth", function (src, commandData, chan) {
