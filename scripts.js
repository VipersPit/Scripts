/* Viper's Pit v1.0 Scripts.
    By: Blade, cares, Ethan
    Credit to: Max, Lutra
*/
...
Config = {
    ...
    repourl: "http://viperspit.github.io/Scripts/",
    // Repo to load data (announcement/description + tiers) from.
    dataurl: "http://viperspit.github.io/Server-Shit/",
    ...
    plugins: ['bot', 'reg', 'ranks', 'utils', 'rtd', 'yeolde', 'channeldata', 'emotes', 'lists', 'init', 'feedmon', 'tours', 'commands', 'events'],
    data: ['emoji'],
...
SESSION.identifyScriptAs("Viper's Pit Script v0.10.1");
